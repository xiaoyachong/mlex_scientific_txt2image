...
class myDataloader:
    ...
    def __init__(self, 
        ...
        self.root_rings = root_rings
        self.root_peaks = root_peaks
    ...
    @staticmethod
    def create_datasets(root_rings: str = None, 
                        root_peaks: str = None,
                        root_empty: str = None, 
                        transform: Callable = None,
                        format: str = None,
        ...
        if from_subfolders:
            dataset_rings = dset.ImageFolder(root=root_rings, transform=transform)
            dataset_peaks = dset.ImageFolder(root=root_peaks, transform=transform)
            dataset_empty = dset.ImageFolder(root=root_empty, transform=transform)
    ...
    def dataloader(self):
        ds = self.create_datasets(root_rings = self.root_rings, 
                                  root_peaks = self.root_peaks,
